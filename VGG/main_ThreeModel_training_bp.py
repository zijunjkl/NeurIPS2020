...
def main(fold1,fold2,fold3,fold4,fold5,foldL1,foldL2,foldL3,foldL4,foldL5, name, rightau, rightexp, leftexp):
    ...
    for out_e in range(out_epo):
        train_image, train_explabel, train_AUlabel, train_AUprob = get_train_batch_ck(900, trainD_path, trainL, load_PGM_pAUconfig, 0)
    ...
    #        for ti in range(len(start_idx_train)): 
            train_image, train_explabel, train_AUlabel, train_AUprob = get_train_batch_ck(900, trainD_path, trainL, load_PGM_pAUconfig, start_idx_train[0])
    ...
    #        for ti in range(len(start_idx_test)): 
            test_image, test_explabel, test_AUlabel, test_AUprob = get_train_batch_ck(900, testD_path, testL, load_PGM_pAUconfig, start_idx_test[0])
...
main(fold1_in,fold2_in,fold3_in,fold4_in,fold5_in,fold1_la,fold2_la,fold3_la,fold4_la,fold5_la,'joint_1_all2.p','AU_model_5fold_1',  'right_exp_5fold_1', 'left_exp_5fold_1')
main(fold2_in,fold3_in,fold4_in,fold5_in,fold1_in,fold2_la,fold3_la,fold4_la,fold5_la,fold1_la,'joint_2_all2.p','AU_model_5fold_2',  'right_exp_5fold_2', 'left_exp_5fold_2')
main(fold3_in,fold4_in,fold5_in,fold1_in,fold2_in,fold3_la,fold4_la,fold5_la,fold1_la,fold2_la,'joint_3_all2.p','AU_model_5fold_3',  'right_exp_5fold_3', 'left_exp_5fold_3')
main(fold4_in,fold5_in,fold1_in,fold2_in,fold3_in,fold4_la,fold5_la,fold1_la,fold2_la,fold3_la,'joint_4_all2.p','AU_model_5fold_4',  'right_exp_5fold_4', 'left_exp_5fold_4')
  
main(fold5_in,fold1_in,fold2_in,fold3_in,fold4_in,fold5_la,fold1_la,fold2_la,fold3_la,fold4_la,'joint_5_all2.p','AU_model_5fold_5',  'right_exp_5fold_5', 'left_exp_5fold_5')
pdb.set_trace()
