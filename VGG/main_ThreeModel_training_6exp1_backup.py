...
from helper_functions import Compute_F1score, Compute_F1score_au, posterior_entropy_three_2
...
def main(fold1,fold2,fold3,fold4,fold5,foldL1,foldL2,foldL3,foldL4,foldL5, name, rightau, rightexp, leftexp):
...
#     load_PGM_pExp, load_PGM_pAUconfig = pickle.load(pickle_in)
    ...
    pickle_in = open(os.path.join( '/home/zijun/Documents/PseudoBN/6exp-8AU/mysoln_v2/'+'list_AU_config.p'), "rb" )
    load_AUconfig = pickle.load(pickle_in)
    
    pickle_in = open( os.path.join( '/home/zijun/Documents/PseudoBN/6exp-8AU/mysoln_v2/'+ 'PGM_p.p'), "rb" )
    load_PGM_pExp, load_PGM_pAUconfig = pickle.load(pickle_in)
    ...
    balance_e = 0.01 #for left expression
...
main(fold1_in,fold2_in,fold3_in,fold4_in,fold5_in,fold1_la,fold2_la,fold3_la,fold4_la,fold5_la,'joint_1_all2cros_pseudo_v3_vgg.p','AU_model_5fold_1ck_pseudo_v3',  'right_exp_5fold_1_testck_pseudo_v3', 'left_exp_5fold_1')
main(fold5_in,fold1_in,fold2_in,fold3_in,fold4_in,fold5_la,fold1_la,fold2_la,fold3_la,fold4_la,'joint_2_all2cros_pseudo_v3_vgg.p','AU_model_5fold_2ck_pseudo_v3',  'right_exp_5fold_2_testck_pseudo_v3', 'left_exp_5fold_2')
main(fold4_in,fold5_in,fold1_in,fold2_in,fold3_in,fold4_la,fold5_la,fold1_la,fold2_la,fold3_la,'joint_3_all2cros_pseudo_v3_vgg.p','AU_model_5fold_3ck_pseudo_v3',  'right_exp_5fold_3_testck_pseudo_v3', 'left_exp_5fold_3')
main(fold3_in,fold4_in,fold5_in,fold1_in,fold2_in,fold3_la,fold4_la,fold5_la,fold1_la,fold2_la,'joint_4_all2cros_pseudo_v3_vgg.p','AU_model_5fold_4ck_pseudo_v3',  'right_exp_5fold_4_testck_pseudo_v3', 'left_exp_5fold_4')
main(fold2_in,fold3_in,fold4_in,fold5_in,fold1_in,fold2_la,fold3_la,fold4_la,fold5_la,fold1_la,'joint_5_all2cros_pseudo_v3_vgg.p','AU_model_5fold_5ck_pseudo_v3',  'right_exp_5fold_5_testck_pseudo_v3', 'left_exp_5fold_5')
pdb.set_trace()
