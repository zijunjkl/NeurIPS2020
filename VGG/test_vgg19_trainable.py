...
def main(fold1_index, fold2_index, fold3_index, fold1_label, fold2_label, fold3_label,title_string):
    ...
    train = tf.train.GradientDescentOptimizer(0.01).minimize(loss_exp)
...
name_string = 'LeftExp'
file1 = [name_string + '-fold1_pre_bp4d.p'][0]
file2 = [name_string + '-fold2_pre_bp4d.p'][0]
file3 = [name_string + '-fold3_pre_bp4d.p'][0]
