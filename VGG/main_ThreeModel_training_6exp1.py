...
#        vgg = vgg19.Vgg19('/home/zijun/Documents/VGG-model/ThreeModels_withCNN/save_vgg/LeftExp-fold1_pre_ck.npy')
    ...
    balance_w = 0.00005 #for right AU
    print('start')
    for out_e in range(out_epo):
        ...
        acc_test2 = (np.ravel(testL[:,0]-2)==np.argmax(posterior_test2, axis=1)).sum()/len(testL)
        
        perf_posterior.append([acc_train, acc_test])
        print('----------Outer_epo %d Posterior Acc Test(2) %f Test(3) %f-------------' %(out_e, acc_test, acc_test2))
        print(' ')
        LR = 0.0001
...
#            
#            loss_left,pred_exp_left = sess.run([loss2,pred_Expression], feed_dict={images: train_image_224, true_out: train_explabel, train_mode: False, posterior_:posterior, balance_e_: balance_e  })
#            #loss_left=0
#            # right AU output
...
#main(fold1_in,fold2_in,fold3_in,fold4_in,fold5_in,fold1_la,fold2_la,fold3_la,fold4_la,fold5_la,'LeftExp-fold1_pre_ck.npy','AU_model_5fold_1ck',  'right_exp_5fold_1_testck', 'left_exp_5fold_1')
#main(fold5_in,fold1_in,fold2_in,fold3_in,fold4_in,fold5_la,fold1_la,fold2_la,fold3_la,fold4_la,'LeftExp-fold2_pre_ck.npy','AU_model_5fold_2ck',  'right_exp_5fold_2_testck', 'left_exp_5fold_2')
#main(fold4_in,fold5_in,fold1_in,fold2_in,fold3_in,fold4_la,fold5_la,fold1_la,fold2_la,fold3_la,'LeftExp-fold3_pre_ck.npy','AU_model_5fold_3ck',  'right_exp_5fold_3_testck', 'left_exp_5fold_3')
main(fold3_in,fold4_in,fold5_in,fold1_in,fold2_in,fold3_la,fold4_la,fold5_la,fold1_la,fold2_la,'LeftExp-fold4_pre_ck.npy','AU_model_5fold_4ck',  'right_exp_5fold_4_testck', 'left_exp_5fold_4')
main(fold2_in,fold3_in,fold4_in,fold5_in,fold1_in,fold2_la,fold3_la,fold4_la,fold5_la,fold1_la,'LeftExp-fold5_pre_ck.npy','AU_model_5fold_5ck',  'right_exp_5fold_5_testck', 'left_exp_5fold_5')
#pdb.set_trace()
