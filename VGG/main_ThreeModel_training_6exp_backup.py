...
pdb.set_trace()
def main(fold1,fold2,fold3, foldL1,foldL2,foldL3 , name, rightau, rightexp, leftexp):
...
#     load_PGM_pExp, load_PGM_pAUconfig = pickle.load(pickle_in)
    ...
    pickle_in = open( os.path.join( '/home/zijun/Documents/PseudoBN/6exp-8AU/mysoln_v2/'+ 'PGM_p-SEM.p'), "rb" )
    load_PGM_pExp, load_PGM_pAUconfig = pickle.load(pickle_in)
...
main(fold1_index, fold2_index, fold3_index, fold1_label, fold2_label, fold3_label,'joint_1_all2cros_pseudo_v3_vgg_bp4d.p','AU_model_5fold_1ck_pseudo_v3',  'right_exp_5fold_1_testck_pseudo_v3', 'left_exp_5fold_1')
main(fold1_index, fold3_index, fold2_index, fold1_label, fold3_label, fold2_label,'joint_2_all2cros_pseudo_v3_vgg_bp4d.p','AU_model_5fold_2ck_pseudo_v3',  'right_exp_5fold_2_testck_pseudo_v3', 'left_exp_5fold_2')
main(fold2_index, fold3_index, fold1_index, fold2_label, fold3_label, fold1_label,'joint_3_all2cros_pseudo_v3_vgg_bp4d.p','AU_model_5fold_3ck_pseudo_v3',  'right_exp_5fold_3_testck_pseudo_v3', 'left_exp_5fold_3')
#pdb.set_trace()
